...
public interface Planner extends MDPSolverInterface{
	...
	/**
	 * This method will cause the {@link burlap.behavior.singleagent.planning.Planner} to begin planning from the specified initial {@link burlap.oomdp.core.states.State}.
	 ...
	 * @return a {@link burlap.behavior.policy.Policy} that captures the planning results from input {@link burlap.oomdp.core.states.State}.
	 */
