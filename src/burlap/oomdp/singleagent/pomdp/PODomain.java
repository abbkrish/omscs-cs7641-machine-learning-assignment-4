...
/**
 * A class for defining POMDP domains. Primarily, this adds to the {@link burlap.oomdp.singleagent.SADomain} definition
 * an {@link burlap.oomdp.singleagent.pomdp.ObservationFunction}. It also adds an optional {@link burlap.behavior.singleagent.auxiliary.StateEnumerator}
...
public class PODomain extends SADomain {
	...
	/**
	 * Sets the {@link burlap.oomdp.singleagent.pomdp.ObservationFunction} used by the domain.
	 * @param observationFunction the {@link burlap.oomdp.singleagent.pomdp.ObservationFunction} to be used by the domain.
	 */
	...
	/**
	 * Returns the {@link burlap.oomdp.singleagent.pomdp.ObservationFunction} used by this domain.
	 * @return the {@link burlap.oomdp.singleagent.pomdp.ObservationFunction} used by this domain.
	 */
