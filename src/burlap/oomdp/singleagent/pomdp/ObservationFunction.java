...
/**
 * Defines the observation function and observations associated with a POMDP domain ({@link burlap.oomdp.singleagent.pomdp.PODomain}).
 ...
 * and {@link #sampleObservationByEnumeration(burlap.oomdp.core.states.State, burlap.oomdp.singleagent.GroundedAction)}, respectively,
 * provided that the {@link #getAllPossibleObservations()} method is implemented. However, these methods may be computationally
 * inefficient because they require enumerating all observations as returned by the {@link #getObservationProbabilities(burlap.oomdp.core.states.State, burlap.oomdp.singleagent.GroundedAction)}
...
public abstract class ObservationFunction {
	...
	/**
	 * The POMDP domain with which this {@link burlap.oomdp.singleagent.pomdp.ObservationFunction} is associated.
	 */
	protected PODomain domain;

	/**
	 * Initializes and set the {@link burlap.oomdp.singleagent.pomdp.PODomain} object's {@link burlap.oomdp.singleagent.pomdp.ObservationFunction}
	 * to this object.
	 * @param domain the {@link burlap.oomdp.singleagent.pomdp.PODomain} with which this {@link burlap.oomdp.singleagent.pomdp.ObservationFunction} is associated.
	 */
	 ...
	 * @param observation the observation, represented by a {@link burlap.oomdp.core.states.State}
	 ...
	 * The function is represented as a {@link java.util.List} of {@link burlap.oomdp.singleagent.pomdp.ObservationFunction.ObservationProbability} objects,
	 * which is a pair of an observation (represented by a {@link burlap.oomdp.core.states.State} and double specifying its mass/density.
	 ...
	 * @return the observation probability mass/density function represented by a {@link java.util.List} of {@link burlap.oomdp.singleagent.pomdp.ObservationFunction.ObservationProbability} objects.
	 */
	 ...
	 * @return an observation represented with a {@link burlap.oomdp.core.states.State}.
	 */
	...
	/**
	 * A superclass method for easily implementing the {@link #getObservationProbabilities(burlap.oomdp.core.states.State, burlap.oomdp.singleagent.GroundedAction)} method
	 ...
	 * and assigning their probability according to the {@link #getObservationProbability(burlap.oomdp.core.states.State, burlap.oomdp.core.states.State, burlap.oomdp.singleagent.GroundedAction)}
	 ...
	 * for the {@link #getObservationProbabilities(burlap.oomdp.core.states.State, burlap.oomdp.singleagent.GroundedAction)} method.
	 * @param state the true MDP state that generated the observations
	 * @param action the action that led to the MDP state and which generated the observations.
	 * @return the observation probability mass/density function represented by a {@link java.util.List} of {@link burlap.oomdp.singleagent.pomdp.ObservationFunction.ObservationProbability} objects.
	 */
	...
	/**
	 * A superclass method for easily implementing the {@link #sampleObservation(burlap.oomdp.core.states.State, burlap.oomdp.singleagent.GroundedAction)} method that
	 * samples an observation by first getting all non-zero probability observations, as returned by the {@link #getObservationProbabilities(burlap.oomdp.core.states.State, burlap.oomdp.singleagent.GroundedAction)}
	 ...
	 * inefficient; therefore, it may be better to directly implement the {@link #sampleObservation(burlap.oomdp.core.states.State, burlap.oomdp.singleagent.GroundedAction)}
