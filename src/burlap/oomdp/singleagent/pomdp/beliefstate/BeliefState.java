 ...
 * states. However, it does require that the probability density function be returnable ({@link #belief(burlap.oomdp.core.states.State)},
 * to be able to sample an MDP state from the belief distribution {@link #sampleStateFromBelief()},
 * and a mechanism to update the belief state with respect to some observation and action {@link #getUpdatedBeliefState(burlap.oomdp.core.states.State, burlap.oomdp.singleagent.GroundedAction)}.
 *
...
public interface BeliefState extends State {
	 ...
	 * @param s the the input MDP state defined by a {@link burlap.oomdp.core.states.State} instance.
	 ...
	 * @return an MDP state defined by a {@link burlap.oomdp.core.states.State} instance.
	 */
	 ...
	 * and action taken.
	 * @param observation the conditioned POMDP observation defined by a {@link burlap.oomdp.core.states.State} instance.
