 ...
 * all agents to play as the same {@link burlap.oomdp.stochasticgames.SGAgentType} and therefore is only valid in symmetric games.
...
public class AllPairWiseSameTypeMS implements MatchSelector {
	 ...
	 * @param at the {@link burlap.oomdp.stochasticgames.SGAgentType} that all agents will play as
